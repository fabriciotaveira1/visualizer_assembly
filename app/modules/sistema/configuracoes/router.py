...
from app.modules.sistema.configuracoes.schemas import ConfiguracaoCondominioPayload, ConfiguracaoCondominioResponse
from app.modules.sistema.configuracoes.service import get_or_create_configuracao, upsert_configuracao
