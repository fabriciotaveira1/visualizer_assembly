...
from app.modules.sistema.configuracoes.models import ConfiguracaoCondominio
from app.modules.sistema.configuracoes.schemas import ConfiguracaoCondominioPayload
