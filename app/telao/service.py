...
from app.presenca.service import get_assembleia_by_id
from app.telao.manager import telao_manager
from app.votacao.service import get_pauta_by_id, get_resultado_pauta
